...
class RectangularRoom(object):
    ...
    def __init__(self, width, height, dirt_amount):
        ...
        for w in range(width):
            for h in range(height):
                tile = (w,h)
                self.tile_dirt[tile] = dirt_amount
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        dirt = self.get_dirt_amount(x,y)
        
        self.tile_dirt[(x,y)] = max(0,dirt-capacity)
...
class FurnishedRoom(RectangularRoom):
    ...
    def get_num_tiles(self):
        ...
        """
        #raise NotImplementedError
        return RectangularRoom.get_num_tiles(self) - len(self.furniture_tiles)
...
def run_simulation(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
    ...
    for n in range(num_trials):
        ...
        anim = ps3_visualize.RobotVisualization(num_robots, width, height,False,0.05)
...
# print ('avg time steps: ' + str(run_simulation(1, 1.0, 1, 20, 20, 3, 0.7, 50, StandardRobot)))
print ('avg time steps: ' + str(run_simulation(10, 1.0, 1, 12, 8, 3, 0.9, 50, StandardRobot)))
